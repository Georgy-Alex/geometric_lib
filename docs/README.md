...
- Проверить корректность работы функций с различными входными данными.
(крайние и недопустимые случаи может не отработать)
...
(тетсты могут неотработать при невалидных данных)
