...
- Проверить корректность работы функций с различными входными данными (расматриваю только положительные значения).
...
(тесты рабоьают только с положительными значениями
)
